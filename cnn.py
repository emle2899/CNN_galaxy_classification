...
class CNNModel(object):
    ...
    def __init__(self,train_folder, validation_folder, holdout_folder, target_size, augmentation_strength=0.2,
                preprocessing=None, batch_size = 8, nb_classes = 4, nb_epoch = 40):
    ...
    def fitting(self):
        ...
        checkpointer = callbacks.ModelCheckpoint(filepath=('evaluate/checkpoint.hdf5'), verbose=1, save_best_only=True)
    ...
    def plot_history(self):
        ...
        # plt.savefig('evaluate/acc_hist2.png')
        plt.close()
        # plt.show()
        ...
        plt.xlabel('Epoch')
        plt.legend(['Train', 'Test'], loc='upper left')
        # plt.savefig('evaluate/loss_hist2.png')
        plt.close()
        # plt.show()
    ...
    def plot_images(self, n=1, image_ind=None):
        ...
        for i in image:
            ...
            # plt.savefig('g_images/ngalaxyid'+ str(i) +'.png')
            plt.show()
...
if __name__ == '__main__':
    ...
    # get plots
    CNN.plot_history()
    CNN.plot_images(image_ind = [86,87,137,138])
